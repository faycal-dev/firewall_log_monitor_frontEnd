...
const realTimeMonitor = lazy(() =>
  import("./views/dashboard/admin/realTimeMonitor")
);
const Filters = lazy(() =>
  import("./views/dashboard/admin/filters")
);
const MatriceDeFlux = lazy(() =>
  import("./views/dashboard/admin/matriceDeFlux")
);
const Stats = lazy(() =>
...
const MatriceDetail = lazy(() =>
  import("./views/dashboard/admin/detail_matrice_de_flux")
);
